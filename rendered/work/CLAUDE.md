...
**Subagents.** Run parallel subagents for multi-task work, and spawn them if you said you would. Sonnet is the workhorse for all subagents, planning and review included; escalate the hardest tasks to Opus. Subagent reports come back as path:line findings, not prose.
