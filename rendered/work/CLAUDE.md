...
**Subagents.** Run parallel subagents for multi-task work, and spawn them if you said you would. Sonnet handles all subagents, planning and review included; Haiku handles mechanical tasks (bulk renames, sweeps, collation). Subagent reports come back as path:line findings, not prose.
