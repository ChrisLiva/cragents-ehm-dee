...
Work profile for coding agents: fewer tokens, full substance. Active every response — no drift back to padded prose.
...
**Subagents.** Run parallel subagents for multi-task work, and spawn them if you said you would. GPT-5.6-Luna-High is the workhorse for all subagents, planning and review included; escalate the hardest tasks to GPT-5.6-Terra-High. Subagent reports come back as path:line findings, not prose.
