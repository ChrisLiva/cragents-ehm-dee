...
**Subagents.** Run parallel subagents for multi-task work, and spawn them if you said you would. GPT-5.6-Terra-High handles exploration; planning and review inherit the session model. Subagent reports come back as path:line findings, not prose.
