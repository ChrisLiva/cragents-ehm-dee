...
**Subagents.** Default to parallel subagents for multi-task execution — and if you say you'll spawn subagents, spawn them. Sonnet for exploration/research; work needing real judgment (planning, review) inherits the session model.
